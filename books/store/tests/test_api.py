...
class BookAPITestCase(APITestCase):
    def setUp(self) -> None:
        ...
        self.book_1 = Book.objects.create(name='Test book 1', price=25,
                                          author_name='Author 1', owner=self.user, discount=15)
        self.book_2 = Book.objects.create(name='Test book 2', price=55,
                                          author_name='Author 5')
        self.book_3 = Book.objects.create(name='Test book Author 1', price=65,
    ...
    def test_get(self):
        ...
        self.assertEqual(serializer_data[0]['discounted_price'], '10.00')
